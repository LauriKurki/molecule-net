...
def predict_with_state(state, dataloader, num_batches, loss_fn):
    preds = []
    inputs = []
    targets = []
    xyzs = []
    ...
    for i in range(num_batches):
        ...
        (
            batch_inputs, batch_targets, batch_preds, batch_xyzs
        ) = predict_step(
            state,
            batch,
            loss_fn
...
def train_and_evaluate(
    ...
    # Prediction
    prediction_hook = hooks.SegmantionPredictionHook(
        workdir=workdir,
